...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    reading_list_entries: Attribute.Relation<
      'api::book.book',
      'oneToMany',
      'api::reading-list-entry.reading-list-entry'
    >;
    avgRating: Attribute.Decimal & Attribute.DefaultTo<0>;
...
export interface ApiReadingListEntryReadingListEntry
...
export interface ApiThemeSettingThemeSetting extends Schema.SingleType {
  ...
  attributes: {
    selectedTheme: Attribute.Enumeration<['light ', 'dark', 'blue']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::reading-list-entry.reading-list-entry': ApiReadingListEntryReadingListEntry;
